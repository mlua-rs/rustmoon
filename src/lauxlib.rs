...
pub const LEVELS1: libc::c_int = 10; /* size of the first part of the stack */
pub const LEVELS2: libc::c_int = 11; /* size of the second part of the stack */
...
unsafe extern "C" fn pushglobalfuncname(L: *mut lua_State, ar: *mut lua_Debug) -> libc::c_int {
...
unsafe extern "C" fn lastlevel(L: *mut lua_State) -> libc::c_int {
...
pub unsafe extern "C" fn luaL_traceback(
    ...
    luaL_checkstack(L, 10 as libc::c_int, ptr::null_mut() as *const libc::c_char);
...
unsafe fn luaL_typename(L: *mut lua_State, i: libc::c_int) -> *const i8 {
...
unsafe extern "C" fn typeerror(
    ...
    let msg;
    let typearg;
    if luaL_getmetafield(L, arg, b"__name\0" as *const u8 as *const libc::c_char) == LUA_TSTRING {
...
unsafe extern "C" fn tag_error(L: *mut lua_State, arg: libc::c_int, tag: libc::c_int) {
...
*/
#[no_mangle]
pub unsafe extern "C" fn luaL_where(L: *mut lua_State, level: libc::c_int) {
    let mut ar = lua_Debug {
        event: 0,
        name: 0 as *const libc::c_char,
        namewhat: 0 as *const libc::c_char,
...
pub unsafe extern "C" fn luaL_fileresult(
    ...
    let en: libc::c_int = *errno_location();
    if stat != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn luaL_execresult(L: *mut lua_State, stat: libc::c_int) -> libc::c_int {
    let what = b"exit\0" as *const u8 as *const libc::c_char;
    if stat == -(1 as libc::c_int) {
        return luaL_fileresult(L, 0 as libc::c_int, ptr::null_mut() as *const libc::c_char);
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn luaL_setmetatable(L: *mut lua_State, tname: *const libc::c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn luaL_checktype(L: *mut lua_State, arg: libc::c_int, t: libc::c_int) {
    if lua_type(L, arg) != t {
        tag_error(L, arg, t);
    }
}
...
#[no_mangle]
pub unsafe extern "C" fn luaL_checkany(L: *mut lua_State, arg: libc::c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn luaL_checknumber(L: *mut lua_State, arg: libc::c_int) -> lua_Number {
...
#[no_mangle]
pub unsafe extern "C" fn luaL_checkinteger(L: *mut lua_State, arg: libc::c_int) -> lua_Integer {
    let mut isnum: libc::c_int = 0;
...
unsafe extern "C" fn resizebox(
    ...
    if temp.is_null() && newsize > 0 {
        ...
        luaL_error(
            L,
            b"not enough memory for buffer allocation\0" as *const u8 as *const libc::c_char,
        );
    }
    (*box_0).box_0 = temp;
    (*box_0).bsize = newsize;
...
unsafe extern "C" fn newbox(L: *mut lua_State, newsize: size_t) -> *mut libc::c_void {
    let mut box_0 = lua_newuserdata(L, ::core::mem::size_of::<UBox>() as size_t) as *mut UBox;
    (*box_0).box_0 = ptr::null_mut() as *mut libc::c_void;
    ...
    if ((*B).size).wrapping_sub((*B).n) < sz {
        ...
        if buffonstack(B) {
            ...
            memcpy(
                ...
                ((*B).n).wrapping_mul(::core::mem::size_of::<libc::c_char>() as size_t),
            );
        }
        (*B).b = newbuff;
        (*B).size = newsize;
...
#[no_mangle]
pub unsafe extern "C" fn luaL_addlstring(B: *mut luaL_Buffer, s: *const libc::c_char, l: size_t) {
    if l > 0 {
        let b = luaL_prepbuffsize(B, l);
        memcpy(
            b as *mut libc::c_void,
            s as *const libc::c_void,
            l.wrapping_mul(::core::mem::size_of::<libc::c_char>() as usize),
        );
        luaL_addsize(B, l);
    }
}
...
#[no_mangle]
pub unsafe extern "C" fn luaL_addstring(B: *mut luaL_Buffer, s: *const libc::c_char) {
...
pub unsafe extern "C" fn luaL_addvalue(B: *mut luaL_Buffer) {
    let L = (*B).L;
    let mut l: size_t = 0;
    let s = lua_tolstring(L, -(1 as libc::c_int), &mut l);
    if buffonstack(B) {
...
#[no_mangle]
pub unsafe extern "C" fn luaL_ref(L: *mut lua_State, mut t: libc::c_int) -> libc::c_int {
    let mut ref_0;
    if lua_isnil(L, -1) != 0 {
        lua_pop(L, 1);
        return LUA_REFNIL;
    ...
    if ref_0 != 0 as libc::c_int {
        ...
        ref_0 = lua_rawlen(L, t) as libc::c_int + 1;
    }
...
#[no_mangle]
pub unsafe extern "C" fn luaL_unref(L: *mut lua_State, mut t: libc::c_int, ref_0: libc::c_int) {
    if ref_0 >= 0 {
        t = lua_absindex(L, t);
        lua_rawgeti(L, t, freelist as lua_Integer);
        lua_rawseti(L, t, ref_0 as lua_Integer);
...
#[repr(C)]
pub struct LoadF {
    pub n: libc::c_int,             /* number of pre-read characters */
    pub f: *mut FILE,               /* file being read */
    pub buff: [libc::c_char; 8192], /* area for reading file */
}
...
unsafe extern "C" fn getF(
    ...
    if (*lf).n > 0 as libc::c_int {
        ...
        *size = (*lf).n as size_t; /* return them (chars already in buffer) */
        (*lf).n = 0 as libc::c_int; /* no more pre-read characters */
    } else {
        ...
        if feof((*lf).f) != 0 {
            return ptr::null_mut() as *const libc::c_char;
        }
        ...
        *size = fread(
            ...
            1 as size_t,
            1,
            //::core::mem::size_of::<[libc::c_char; 8192]>() as size_t,
            (*lf).f, /* read block */
        );
    }
...
unsafe extern "C" fn errfile(
    ...
    fnameindex: libc::c_int,
) -> libc::c_int {
    let errno: libc::c_int = *errno_location();
    let serr: *const libc::c_char = strerror(errno);
    let filename = lua_tostring(L, fnameindex).offset(1 as libc::c_int as isize);
    lua_pushfstring(
        L,
    ...
    lua_settop(L, -(1 as libc::c_int) - 1);
    return LUA_ERRFILE;
}
...
*/
unsafe extern "C" fn skipcomment(lf: *mut LoadF, cp: *mut libc::c_int) -> libc::c_int {
    *cp = skipBOM(lf);
    let mut c = *cp;
    if c == '#' as i32 {
        loop {
...
pub unsafe extern "C" fn luaL_loadfilex(
    ...
    let readstatus: libc::c_int;
    let mut c: libc::c_int = 0;
    let fnameindex = lua_gettop(L) + 1 as libc::c_int;
    if filename.is_null() {
        lua_pushliteral(L, "=stdin");
        lf.f = fdopen(STDIN_FILENO, b"r\0" as *const u8 as *const libc::c_char)
    } else {
    ...
    if c == (*::core::mem::transmute::<&[u8; 5], &[libc::c_char; 5]>(b"\x1BLua\0"))[0 as usize]
        as libc::c_int
        && !filename.is_null()
    {
    ...
    if c != EOF {
        lf.buff[lf.n as usize] = c as libc::c_char;
        lf.n = lf.n + 1;
    }
    status = lua_load(
        L,
...
#[no_mangle]
pub unsafe extern "C" fn luaL_loadstring(L: *mut lua_State, s: *const libc::c_char) -> libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn luaL_len(L: *mut lua_State, idx: libc::c_int) -> lua_Integer {
    let l: lua_Integer;
    let mut isnum: libc::c_int = 0;
    lua_len(L, idx);
...
pub unsafe extern "C" fn luaL_tolstring(
    ...
    if luaL_callmeta(L, idx, b"__tostring\0" as *const u8 as *const libc::c_char) != 0 {
        ...
        match lua_type(L, idx) {
            ...
            _ => {
                let tt = luaL_getmetafield(L, idx, b"__name\0" as *const u8 as *const libc::c_char);
...
pub unsafe extern "C" fn luaL_gsub(
    ...
    let mut wild: *const libc::c_char;
    let l = strlen(p);
...
unsafe extern "C" fn l_alloc(
    ...
    if nsize == 0 {
        free(ptr);
        return ptr::null_mut() as *mut libc::c_void;
    } else {
        let newptr = libc::realloc(ptr, nsize);
...
unsafe extern "C" fn panic(L: *mut lua_State) -> libc::c_int {
    let stderr_fd = fdopen(STDERR_FILENO, b"w\0" as *const u8 as *const libc::c_char);
    fprintf(
        stderr_fd,
