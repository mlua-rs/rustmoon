...
unsafe extern "C" fn checkfield(L: *mut lua_State, key: *const c_char, n: c_int) -> c_int {
...
unsafe extern "C" fn tinsert(L: *mut lua_State) -> c_int {
    checktab(L, 1 as c_int, 1 as c_int | 2 as c_int | 4 as c_int);
    ...
    match lua_gettop(L) {
        ...
        3 => {
            ...
            while i > pos {
                lua_geti(L, 1 as c_int, i - 1 as c_int as c_longlong);
...
unsafe extern "C" fn tremove(L: *mut lua_State) -> c_int {
    ...
    if pos != size {
        (1 as c_int as c_longlong <= pos && pos <= size + 1 as c_int as c_longlong
            || luaL_argerror(
                L,
                1 as c_int,
                b"position out of bounds\0" as *const u8 as *const c_char,
    ...
    while pos < size {
        lua_geti(L, 1 as c_int, pos + 1 as c_int as c_longlong);
        lua_seti(L, 1 as c_int, pos);
        pos += 1;
    }
    lua_pushnil(L);
...
unsafe extern "C" fn tmove(L: *mut lua_State) -> c_int {
    ...
    if e >= f {
        ...
        if t > e || t <= f || tt != 1 as c_int && lua_compare(L, 1 as c_int, tt, 0 as c_int) == 0 {
            while i < n {
...
unsafe extern "C" fn addfield(L: *mut lua_State, b: *mut luaL_Buffer, i: lua_Integer) {
    ...
    if lua_isstring(L, -(1 as c_int)) == 0 {
        luaL_error(
            L,
            b"invalid value (%s) at index %d in table for 'concat'\0" as *const u8 as *const c_char,
...
unsafe extern "C" fn pack(L: *mut lua_State) -> c_int {
    ...
    lua_setfield(L, 1 as c_int, b"n\0" as *const u8 as *const c_char);
    return 1 as c_int;
}
...
unsafe extern "C" fn sort_comp(L: *mut lua_State, a: c_int, b: c_int) -> c_int {
    if lua_type(L, 2 as c_int) == 0 as c_int {
        ...
        lua_callk(L, 2 as c_int, 1 as c_int, 0 as c_int as lua_KContext, None);
...
unsafe extern "C" fn choosePivot(lo: IdxT, up: IdxT, rnd: c_uint) -> IdxT {
    let r4: IdxT = up.wrapping_sub(lo).wrapping_div(4 as c_int as c_uint);
    let p: IdxT = rnd
...
unsafe extern "C" fn auxsort(L: *mut lua_State, mut lo: IdxT, mut up: IdxT, mut rnd: c_uint) {
    while lo < up {
        ...
        if up.wrapping_sub(lo) < 100 as c_uint || rnd == 0 as c_int as c_uint {
            p = lo.wrapping_add(up).wrapping_div(2 as c_int as c_uint);
        } else {
        ...
        if up.wrapping_sub(lo).wrapping_div(128 as c_int as c_uint) > n {
...
pub unsafe extern "C" fn sort(L: *mut lua_State) -> c_int {
    ...
    if n > 1 as c_int as c_longlong {
        ...
        auxsort(L, 1 as c_int as IdxT, n as IdxT, 0 as c_int as c_uint);
    }
    return 0 as c_int;
}
